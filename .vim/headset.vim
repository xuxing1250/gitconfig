...
set shortmess=aoO
badd +728 frameworks/base/media/java/android/media/AudioManager.java
badd +102 frameworks/base/services/java/com/android/server/HeadsetObserver.java
silent! argdel *
edit frameworks/base/media/java/android/media/AudioManager.java
...
silent! normal! zE
let s:l = 1036 - ((25 * winheight(0) + 24) / 48)
...
tabedit /workspace/cc/kenhuang_view/android/frameworks/base/services/java/com/android/server/HeadsetObserver.java
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 96 - ((36 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
96
