...
set shortmess=aoO
badd +60 ~/vobs/kernel/kernel/power/fbearlysuspend.c
badd +36 include/linux/earlysuspend.h
badd +1334 drivers/video/im9815/im9815_fb.c
badd +106 kernel/power/earlysuspend.c
badd +1971 ~/vobs/kernel/sound/arm/audio_path_android.c
badd +254 sound/arm/im9815-mixer.c
silent! argdel *
edit ~/vobs/kernel/kernel/power/fbearlysuspend.c
...
silent! normal! zE
let s:l = 50 - ((38 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
50
normal! 061l
tabedit drivers/video/im9815/im9815_fb.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1474 - ((40 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1474
normal! 012l
tabedit kernel/power/earlysuspend.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
107
normal! 041l
tabedit ~/vobs/kernel/sound/arm/audio_path_android.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 43 - ((17 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 297 - ((22 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
297
normal! 06l
tabedit sound/arm/im9815-mixer.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 745 - ((32 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
745
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 235 - ((23 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
235
