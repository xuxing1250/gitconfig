...
set shortmess=aoO
badd +153 build/core/main.mk
badd +245 vendor/Marvell/tavor/init.rc
silent! argdel *
edit build/core/main.mk
...
silent! normal! zE
let s:l = 153 - ((0 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
153
normal! 051l
tabedit vendor/Marvell/tavor/init.rc
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 110 - ((39 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
110
