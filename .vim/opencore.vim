...
nmap <silent> ,wq :mksession! ~/.vim/last.vim:qall
nmap <silent> ,qq :qall
nmap <silent> ,qf :q!
nmap <silent> ,q :q
nmap <silent> ,w :w!
...
silent only
cd /workspace/cc/kenhuang_view/android
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +714 external/opencore/android/playerdriver.cpp
badd +4347 external/opencore/engines/player/src/pv_player_engine.cpp
badd +99 external/opencore/engines/player/include/pv_player_datasource.h
badd +0 external/opencore/nodes/common/include/pvmf_source_context_data.h
silent! argdel *
edit external/opencore/engines/player/src/pv_player_engine.cpp
...
argglobal
enew
file /media/disk/vobs/zest/external/opencore/__Tag_List__
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 4347 - ((22 * winheight(0) + 24) / 48)
...
exe 'vert 1resize ' . ((&columns * 40 + 78) / 157)
exe 'vert 2resize ' . ((&columns * 116 + 78) / 157)
tabedit external/opencore/engines/player/include/pv_player_datasource.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 99 - ((0 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
99
normal! 010l
tabedit external/opencore/android/playerdriver.cpp
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 713 - ((40 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
713
normal! 077l
lcd /workspace/cc/kenhuang_view/android
tabedit /workspace/cc/kenhuang_view/android/external/opencore/nodes/common/include/pvmf_source_context_data.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 505 - ((36 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
505
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 133 - ((0 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
133
