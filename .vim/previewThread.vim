...
set shortmess=aoO
badd +182 hardware/camera/CameraHal.cpp
badd +76 external/opencore/android/android_audio_output.cpp
badd +103 external/opencore/android/android_audio_input.cpp
badd +939 hardware/alsa_sound/AudioHardwareALSA.cpp
badd +1126 frameworks/base/libs/utils/Threads.cpp
badd +485 frameworks/base/camera/libcameraservice/CameraService.cpp
badd +254 frameworks/base/core/jni/android_hardware_Camera.cpp
badd +91 development/samples/ApiDemos/src/com/example/android/apis/graphics/CameraPreview.java
badd +201 frameworks/base/libs/ui/Camera.cpp
badd +108 frameworks/base/libs/ui/ICamera.cpp
badd +94 external/opencore/android/author/android_camera_input.cpp
badd +1650 packages/apps/Camera/src/com/android/camera/Camera.java
badd +81 hardware/camera/CameraHal.h
silent! argdel *
edit hardware/camera/CameraHal.cpp
...
exe 'vert 1resize ' . ((&columns * 54 + 78) / 157)
exe 'vert 2resize ' . ((&columns * 102 + 78) / 157)
argglobal
enew
file __Tag_List__
let s:cpo_save=&cpo
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 263 - ((23 * winheight(0) + 24) / 48)
...
exe 'vert 1resize ' . ((&columns * 54 + 78) / 157)
exe 'vert 2resize ' . ((&columns * 102 + 78) / 157)
tabedit frameworks/base/libs/utils/Threads.cpp
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1114 - ((23 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1114
normal! 034l
tabedit packages/apps/Camera/src/com/android/camera/Camera.java
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1491 - ((24 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1491
normal! 021l
tabedit hardware/alsa_sound/AudioHardwareALSA.cpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 939 - ((0 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
939
